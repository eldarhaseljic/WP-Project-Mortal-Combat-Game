...
WarriorPlayerOne::WarriorPlayerOne()
{
    //ctor
}

void WarriorPlayerOne::LoadResources()
{
    BITMAP bitmap;
    hbmWarrior = (HBITMAP) LoadImage(NULL, "warrior_p1/stance_black.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    hbmWarriorMask = (HBITMAP) LoadImage(NULL, "warrior_p1/stance_white.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    hbmArmKick = (HBITMAP) LoadImage(NULL, "warrior_p1/arm_black.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    hbmArmKickMask = (HBITMAP) LoadImage(NULL, "warrior_p1/arm_white.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);

    combo = (HBITMAP) LoadImage(NULL, "warrior_p1/combo_black.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    comboMask = (HBITMAP) LoadImage(NULL, "warrior_p1/combo_white.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);

    fly = (HBITMAP) LoadImage(NULL, "warrior_p1/fly_black.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    flyMask = (HBITMAP) LoadImage(NULL, "warrior_p1/fly_white.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);

    kicked = (HBITMAP) LoadImage(NULL, "warrior_p1/kicked_black.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    kickedMask = (HBITMAP) LoadImage(NULL, "warrior_p1/kicked_white.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);

    knee = (HBITMAP) LoadImage(NULL, "warrior_p1/knee_black.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    kneeMask = (HBITMAP) LoadImage(NULL, "warrior_p1/knee_white.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);

    knocked = (HBITMAP) LoadImage(NULL, "warrior_p1/knocked_black.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    knockedMask = (HBITMAP) LoadImage(NULL, "warrior_p1/knocked_white.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);

    leg = (HBITMAP) LoadImage(NULL, "warrior_p1/leg_black.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    legMask = (HBITMAP) LoadImage(NULL, "warrior_p1/leg_white.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);

    block = (HBITMAP) LoadImage(NULL, "warrior_p1/block_black.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    blockMask = (HBITMAP) LoadImage(NULL, "warrior_p1/block_white.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
    ...
    comboKick.x = warrior.x-COMBO_KICK_DELTA_X+COMBO_DELTA_P1;
    ...
    kickedKick.x = warrior.x-110;
    kickedKick.y = warrior.y-30;
    ...
    legKick.x = warrior.x-LEG_KICK_DELTA_X+55;
    ...
    punch.x = warrior.x-LEG_KICK_DELTA_X+55;
    punch.y = warrior.y-LEG_KICK_DELTA_Y;
}


void WarriorPlayerOne::Display(HDC& hdcMem, HDC& hdcBuffer)
{
...
void WarriorPlayerOne::setPunch(bool punched, int punch_state, int x, int y)
{
    punch.x = x;
    punch.y = y;
    isPunched = punched;
...
void WarriorPlayerOne::freeResources()
{
